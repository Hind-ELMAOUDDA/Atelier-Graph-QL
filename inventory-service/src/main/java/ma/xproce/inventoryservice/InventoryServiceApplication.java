    ...
    CommandLineRunner start(){
        return args ->{
            List<Creator> creators = List.of(
                    new Creator(1,"Hind", "hind@gmail.com", null),
                    new Creator(2,"Meryem", "meryem@gmail.com", null)
            );
            ...
            for(Creator creator : creators){
                List<Video> videos = List.of(
                        new Video(i,"How Machine Learning Transforms Our Daily Lives", "https://www.youtube.com/watch?v=NjVIQUE8Sgk",
                        ...
                        new Video(++i, "The Role of Machine Learning and AI in Shaping the Future of Education", "https://www.youtube.com/watch?v=gjDPtzJQnyM",
